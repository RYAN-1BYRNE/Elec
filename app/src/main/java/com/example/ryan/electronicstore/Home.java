...
import com.example.ryan.electronicstore.Model.Category;
import com.example.ryan.electronicstore.ViewHolder.MenuViewHolder;
...
public class Home extends AppCompatActivity
    ...
    public boolean onContextItemSelected(MenuItem item) {
        ...
        {
            Toast.makeText(Home.this, "Only assesable to Admin staff", Toast.LENGTH_SHORT).show();
        }
